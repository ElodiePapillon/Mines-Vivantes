...
## 🧠 Constat
Les sites miniers abandonnés génèrent :
- drainage minier acide (eaux acides)
- relargage de métaux lourds (arsenic, plomb, cadmium…)
- destruction des écosystèmes aquatiques et terrestres

Les dispositifs actuels sont coûteux et ne permettent pas une restauration complète.
...
- Stabiliser les bassins versants
- Réduire la contamination des rivières en aval

### Objectifs socio-économiques
- Réduire les coûts publics de gestion des friches
- Créer des emplois locaux en écologie appliquée
- Développer des activités écologiques (tourisme, recherche)
- Positionner la France comme leader européen de la restauration écologique industrielle
...
### 2. Biofiltration active
- bassins de décantation naturels
- bactéries spécialisées (bioremédiation)
- substrats minéraux filtrants

### 3. Zones humides construites
- roseaux, joncs, saules
- micro-organismes détoxifiants
- épuration naturelle continue

### 4. Recolonisation écologique
- insectes aquatiques
- amphibiens
- poissons adaptés aux milieux restaurés

### 5. Renaturation contrôlée
- intégration au réseau hydrographique
...
- assurer le suivi écologique à long terme

Un **comité scientifique national** regroupe :
- écologues
- hydrologues
- microbiologistes
